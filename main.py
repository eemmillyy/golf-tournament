...
app.config[
    'STRIPE_PUBLIC_KEY'] = 'pk_test_51P3hWP2NIIHMdCWByMnDFt2fDtZyUz8GyJ9uBDrseqCvccL3vbSWogxiqd06ddjNqTmIBx9kQOlcPIHMc9Mbooa800RebHEyAB'
app.config[
    'STRIPE_SECRET_KEY'] = 'sk_test_51P3hWP2NIIHMdCWBMTG59K10bYfdedaMYUcxy7zbpciIbLbAT0I0IWuyjnqFzjmlDXoscGIzIU1q4YxLcNu9p0Z6005TfTO30O'
stripe.api_key = app.config['STRIPE_SECRET_KEY']


# Load pre-trained StyleGAN2 model
# model = tf.keras.models.load_model('https://nvlabs-fi-cdn.nvidia.com/stylegan2/networks/table2/stylegan2-ffhq-config-e-Gskip-Dskip.pkl')
app.config[
    'Generative_PUBLIC_KEY'] = 'bWYxa3JuNTZkZHUzbmplOW9qMTB1czltc3U6OGEyMmY5ZTEtNzQxZS00OWJjLWFlOGEtOWYzMWFlNTMxZjc1'
app.config[
    'Generative_SECRET_KEY'] = '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'
